...
export const UI_CONFIG = {
    ...
    VillagerColors: {
        ...
        STONE: "#757575",
        FOOD: "#fd8763ff",
        CRYSTAL_ORE: "#80deffff",
        COAL_ORE: "#303030ff",
        COPPER_ORE: "#b76532ff",
        IRON_ORE: "#b0bec5",
        SILVER_ORE: "#d7dde0ff",
        GOLD_ORE: "#e4b20dea",
        MITHRIL_ORE: "#59e0c8ff",
        MAGIC_HERB: "#81c784",
        WOLF_HIDE: "#a1887f",
        WOLF_PELTS: "#a1887f",
        BEAR_PELT: "#5d4037",
    ...
    LogisticsSystem: {
        ...
        portToPortArrowColor: "#98f8b5ff", // 端口對端口接通物流線箭頭顏色
        portToPortArrowAlpha: 0.95,       // 端口對端口物流線箭頭透明度，範圍 0~1
        portToPortArrowSize: 12,          // 端口對端口物流線箭頭大小
    ...
    ConveyorBuild: {
        ...
        alignmentUnit: 1.0,           // [需求修正] 統一使用 1.0 Tile 對齊，消除半格物流線。
