...
export class WorkerSystem {
    ...
    /**
     * [階段一重構] 相容層：自動物流已搬移至 LogisticsTransferSystem。
     * 保留此委派方法，讓既有外部呼叫端（含測試）維持原有 API。
     */
    processAutomatedLogistics(state, dt) {
        this.logisticsSystem.state = this.state;
        this.logisticsSystem.engine = this.engine;
