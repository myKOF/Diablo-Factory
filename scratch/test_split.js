...
// Remaining segments (Figure 2: horizontal from 1 to 16, vertical from 18 to 32)
const remainingSegments = [];
remainingSegments.push(makeSegment("seg_1", 1.5, 0.5, 1.5, 1.5));
for (let i = 2; i <= 16; i++) {
    remainingSegments.push(makeSegment(`seg_${i}`, i - 0.5, 1.5, i + 0.5, 1.5));
}
const deletedLine = makeSegment("seg_17", 16.5, 1.5, 17.5, 1.5);
for (let i = 18; i <= 32; i++) {
...
// Simulate areLogisticsGroupsTouching between Component 0 and Component 1
